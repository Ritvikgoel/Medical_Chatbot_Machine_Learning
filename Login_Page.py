...
mydb=mysql.connector.connect( host="localhost",user="root",password="",database="medisure")
cursor = mydb.cursor()

base1 = Tk()
base1.title("MediSure - Login")
        ...
        if cursor.rowcount == 1:
            ...
            def send():
                ...
                if msg != '':
                    ...
                    ChatLog.insert(END, "MediSure: " + res + '\n\n')
            ...
            txt = Label(base, text='MediSure:', font=('Verdana', 15))
            txt1 = Label(base, text="^^^ Click Above Button^^^\n(if you want to know how it's work)")
            # txt2=Label(base, text="©MediSure - Let's be sure..")
            ...
            def color_changer():
                ...
                labels = ["©MediSure - Let's be sure..", "• Ritvik Goel - 19BCS3545", "• Mohit Mittal - 19BCS3566",
                          "• Viresh Nalwa - 19BCS3579", ""]
            ...
            photo = PhotoImage(file=r"C:\Users\91999\PycharmProjects\MediSure\Images\images3.png")
            ...
            name = Label(base, text="Name:", font=('Verdana', 10))
